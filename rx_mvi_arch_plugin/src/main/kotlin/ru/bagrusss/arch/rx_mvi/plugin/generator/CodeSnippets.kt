...
const val BASE_PACKAGE = "ru.bagrusss.arch"
const val ARCH_PACKAGE = "$BASE_PACKAGE.mvi"
const val COMMON_PACKAGE = "$BASE_PACKAGE.common"
const val IMPORT_PARCELIZE = "import kotlinx.parcelize.Parcelize"
const val IMPORT_IODATA = "import $COMMON_PACKAGE.IOData"
...
fun createRouterImportsInModule(packageName: String, name: String) =
    """import $ARCH_PACKAGE.navigation.NavRouter
